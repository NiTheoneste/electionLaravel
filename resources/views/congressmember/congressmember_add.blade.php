...
<head>
    ...
    <title>Add congress member</title>
</head>
<body>
    <x-app-layout>
            <x-slot name="header">
                <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                    {{ __('Add congress member') }}
                </h2>
            </x-slot>
        @if($errors->any())
        ...
        <div class="container">
            ...
            <form method='post' action="{{route('congressMember.add')}}">
                @csrf
                <table class='table table-bordered'>
                    ...
                    <tr>
                        ...
                        <span class="glyphicon glyphicon-plus"></span> Create New Congress Member
                        </button>  
