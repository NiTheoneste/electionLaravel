...
Route::get('/states', [StateController::class, 'showHome']);
...
Route::get('/flags', [FlagController::class, 'showHome']);
...
Route::get('/parties', [PartyController::class, 'showHome']);
...
Route::get('/governors', [GovernorController::class, 'showHome']);
...
Route::get('/senators', [SenatorController::class, 'showHome']);
...
Route::get('/presElectors', [PresElectorController::class, 'showHome']);
...
Route::get('/congressMembers', [CongressMemberController::class, 'showHome']);
